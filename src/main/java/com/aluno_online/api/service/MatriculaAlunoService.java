...
import com.aluno_online.api.dtos.DisciplinasAlunoResponse;
...
import com.aluno_online.api.repository.MatriculaAlunoRepository;
...
public class MatriculaAlunoService {
    ...
    public void updateGrades(UUID matriculaAlunoId, AtualizarNotasRequest atualizarNotasRequest) {
    ...
    public void updateStatusToBreak(UUID matriculaAlunoId) {
        MatriculaAluno matriculaAluno =
                matriculaAlunoRepository.findById(matriculaAlunoId)
                        .orElseThrow(() ->
                                new ResponseStatusException(HttpStatus.NOT_FOUND, "Matrícula não encontrada"));
    ...
    public HistoricoAlunoResponse getAcademicTranscript(UUID alunoId) {
